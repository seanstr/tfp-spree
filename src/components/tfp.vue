<template>
  ...
  <q-layout>
    ...
    <q-tabs slot="navigation">
      <q-route-tab slot="title" icon="view_quilt" to="/layout/shop" replace hide="icon" label="Shop" />
      <q-route-tab slot="title" icon="view_quilt" to="/layout/home" replace hide="icon" label="Home" />
